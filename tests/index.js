...
const beforeEach = (framesStub) => {
  __RewireAPI__.__Rewire__(
    'ErrorStackParser',
    errorStackParserMock(framesStub),
  );
};
...
test('RedBoxError error message', (t) => {
  ...
  const renderedError = component.props.children[0].props.children;
  t.equal(
    renderedError[0],
    'Error',
...
test('RedBoxError stack trace', (t) => {
  ...
  const renderedStack = component.props.children[1];
    ...
    <div style={style.stack}>
      <div style={style.frame} key={0}>
        ...
        <div style={style.file}>
          <a style={style.linkToFile} href="webpack:///./components/App.js?">
            webpack:///./components/App.js?:45:12
          </a>
        </div>
      </div>
      <div style={style.frame} key={1}>
        ...
        <div style={style.file}>
          <a
            style={style.linkToFile}
            href="webpack:///./~/react-hot-loader/~/react-hot-api/modules/makeAssimilatePrototype.js?"
          >
  ...
  t.deepEqual(
    ...
    <div style={style.stack}>
      <div style={style.frame} key={0}>
        <div>App.render</div>
        <div style={style.file}>
          <a style={style.linkToFile} href="file:///filename">
            /filename
          </a>
        </div>
      </div>
...
test('RedBoxError with filename and editorScheme', (t) => {
  ...
  const component = createComponent(RedBoxError, {
    error,
    filename,
    editorScheme,
  });
  ...
  t.deepEqual(
    ...
    <div style={style.stack}>
      <div style={style.frame} key={0}>
        <div>App.render</div>
        <div style={style.file}>
          <a style={style.linkToFile} href="subl://open?url=file:///filename">
            /filename
          </a>
        </div>
      </div>
  ...
  t.deepEqual(
    ...
    <div style={style.stack}>
      <div style={style.frame} key={0}>
        <div>App.render</div>
        <div style={style.file}>
          <a style={style.linkToFile} href="vscode://file/filename">
            /filename
          </a>
        </div>
      </div>
    ...
    <div style={style.stack}>
      <div style={style.frame} key={0}>
        ...
        <div style={style.file}>
          <a
            style={style.linkToFile}
            href="subl://open?url=file:///components/App.js&line=45&column=12"
          >
            /components/App.js:45:12
          </a>
        </div>
      </div>
      <div style={style.frame} key={1}>
        ...
        <div style={style.file}>
          <a
            style={style.linkToFile}
            href="subl://open?url=file:///some-path/modules/makeAssimilatePrototype.js&line=17&column=41"
          >
            /some-path/modules/makeAssimilatePrototype.js:17:41
          </a>
        </div>
      </div>
    </div>,
    ...
    <div style={style.stack}>
      <div style={style.frame} key={0}>
        ...
        <div style={style.file}>
          <a
            style={style.linkToFile}
            href="subl://open?url=file:///components/App.js"
          >
            /components/App.js
          </a>
        </div>
      ...
      <div style={style.frame} key={1}>
        ...
        <div style={style.file}>
          <a
            style={style.linkToFile}
            href="subl://open?url=file:///some-path/modules/makeAssimilatePrototype.js"
          >
            /some-path/modules/makeAssimilatePrototype.js
          </a>
        </div>
      </div>
    </div>,
    ...
    <div style={style.stack}>
      <div style={style.frame} key={0}>
        ...
        <div style={style.file}>
          <a
            style={style.linkToFile}
            href="subl://open?url=file:///components/App.js&line=45"
          >
            /components/App.js:45
          </a>
        </div>
      </div>
      <div style={style.frame} key={1}>
        ...
        <div style={style.file}>
          <a
            style={style.linkToFile}
            href="subl://open?url=file:///some-path/modules/makeAssimilatePrototype.js&line=17"
          >
            /some-path/modules/makeAssimilatePrototype.js:17
          </a>
        </div>
      </div>
    </div>,
  ...
  t.deepEqual(
    ...
    <div style={style.stack}>
      ...
      <div style={style.frame} key={1}>
        <div>App.render</div>
        <div style={style.file}>
          <a style={style.linkToFile} href="file://">
            {''}
          </a>
        </div>
      </div>
